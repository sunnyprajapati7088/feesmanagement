   ...
   Date sdob;
    public addfees() {
        initComponents();
         ...
         updateCombobx();
         receipt.setText(Integer.toString(recieptt));
        
    }
    public String insertData(){
        String status="";
       int  reciept_no=Integer.parseInt(receipt.getText());
       ...
       String course=cours.getSelectedItem().toString();
        sdob=dob.getDate();
//       float gstin
    ...
    SimpleDateFormat format=new SimpleDateFormat("yyyy-MM-dd");
        ...
        pst.setString(4, cheque_no);
        pst.setString(5,bank_name);
        pst.setString(6,dd_no);
        pst.setString(7,course);
        pst.setFloat(8,total_amt);
        pst.setString(9, date1);
        pst.setFloat(10,feess);
        pst.setFloat(11,ssgst);
        pst.setFloat(12,ccgst);
        pst.setString(13, remarkk);
        pst.setInt(14,year11);
        pst.setInt(15,year22);
        pst.setInt(16, roll_no);
        pst.setString(17, gst_no);
        pst.setString(18,tn);
        pst.setFloat(19,in_ssgst);
         pst.setFloat(20,in_ccgst);
    ...
    void updateCombobx(){
        ...
        ResultSet rs=pst.executeQuery();
         ...
         while(rs.next()){
             cours.addItem(rs.getString("course_name"));
         }
     ...
     if(modeofpayment.getSelectedItem().toString().equalsIgnoreCase("cheque")){
       ...
       if(modeofpayment.getSelectedItem().toString().equalsIgnoreCase("DD")){
         ...
         return false;
          ...
          if(modeofpayment.getSelectedItem().toString().equalsIgnoreCase("UPI")){
         if(tno.getText().equals("")){
               JOptionPane.showMessageDialog(this,"enter the Transaction_id");
         return false;
         }
          }
    ...
    private void initComponents() {
        ...
        jPanel2.add(receipt, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 30, 60, -1));
        ...
        jPanel5.add(cours, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 70, 190, 20));
    ...
    private void coursActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_coursActionPerformed
        // TODO add your handling code here:
        coursename.setText(cours.getSelectedItem().toString());
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
      ...
      if(validation()==true){
          ...
          if(result.equals("Success")){
              JOptionPane.showMessageDialog(this,"insertion is completed");
              printreciept p=new printreciept();
              p.setVisible(true);
              this.dispose();
          }
          else{
              JOptionPane.showMessageDialog(this,"insertion is not completed");
          }
      }
